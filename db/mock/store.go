...
// ListTransfersBetAccounts mocks base method.
func (m *MockStore) ListTransfersBetAccounts(arg0 context.Context, arg1 db.ListTransfersBetAccountsParams) ([]db.Transfer, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ListTransfersBetAccounts", arg0, arg1)
	ret0, _ := ret[0].([]db.Transfer)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// ListTransfersBetAccounts indicates an expected call of ListTransfersBetAccounts.
func (mr *MockStoreMockRecorder) ListTransfersBetAccounts(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ListTransfersBetAccounts", reflect.TypeOf((*MockStore)(nil).ListTransfersBetAccounts), arg0, arg1)
}
